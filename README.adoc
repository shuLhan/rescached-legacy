...
If invoking +rescached+ without paramter, it will read configuration from +/etc/rescached/rescached.cfg+.
...
'pgl.yoyo.org' for ad server list for use with hosts files to block ads.
